...
setuptools.setup(
    ...
    description="This project is inherited from the original [Abigale](http://git.snowwalkerj.cn:81/SnowWalkerJ/Abigale), with the folloing improvements/changes:.",  # 模块简介
    install_requires=[
        'requests',
        'faker',
        'execjs',
    ...
    url="https://github.com/yanjlee/Abigale2",  # 模块github地址
